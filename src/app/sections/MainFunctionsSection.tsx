...
const features: FeatureCard[] = [
  {
    ...
    description: "Rysuj, pisz, wstawiaj obrazy - wszystko w jednym miejscu. Idealna do wyjaśniania skomplikowanych zagadnień.",
    imageAlt: "Screenshot tablicy w akcji"
  },
  {
    title: "SmartSearch wzorów",
    description: "Szybki dostęp do wzorów matematycznych i fizycznych. Znajdź to czego potrzebujesz w sekundę.",
    imageAlt: "Screenshot wyszukiwarki wzorów"
  },
  {
    title: "AI Assistant",
    description: "Chat który przyjmuje zdjęcia i pomaga z zadaniami w czasie rzeczywistym. Jak dodatkowy korepetytor zawsze pod ręką.",
  ...
  },
  {
    ...
    description: "Uczeń i korepetytor widzą to samo jednocześnie. Zero opóźnień, maksymalna efektywność.",
    imageAlt: "Screenshot współpracy w czasie rzeczywistym"
  },
  {
    title: "Biblioteka plików",
    description: "Dostęp do swoich materiałów w każdej chwili. Wszystkie notatki i zadania w jednym miejscu. (Pro)",
    ...
    <section className="relative py-20 px-4 bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-10">
        <div className="relative max-w-screen-2xl mx-auto h-full">
          ...
          {/* Wzór po lewej */}
          <svg className="absolute left-8 top-20 rotate-12" width="120" height="60" viewBox="0 0 120 60">
            <text x="10" y="35" fill="#3b82f6" fontSize="20" fontFamily="system-ui, -apple-system, sans-serif" fontWeight="600">
              f(x) = y
            </text>
          </svg>

          {/* Wzór po prawej */}
          <svg className="absolute right-8 top-32 -rotate-12" width="140" height="70" viewBox="0 0 140 70">
            <text x="10" y="40" fill="#a855f7" fontSize="22" fontFamily="system-ui, -apple-system, sans-serif" fontWeight="600">
              ∫ dx = x + C
            </text>
          </svg>

          {/* Wzór na dole po lewej */}
          <svg className="absolute left-12 bottom-40 -rotate-6" width="100" height="60" viewBox="0 0 100 60">
            <text x="10" y="35" fill="#ec4899" fontSize="24" fontFamily="system-ui, -apple-system, sans-serif" fontWeight="600">
              x² + y²
            </text>
          </svg>

          {/* Wzór na dole po prawej */}
          <svg className="absolute right-16 bottom-32 rotate-8" width="130" height="65" viewBox="0 0 130 65">
            <text x="10" y="38" fill="#14b8a6" fontSize="20" fontFamily="system-ui, -apple-system, sans-serif" fontWeight="600">
              sin θ + cos θ
            </text>
          </svg>
        </div>
