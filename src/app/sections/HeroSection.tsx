        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 z-10">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Korepetycje online,<br />
              które <span className="text-green-600 relative">
                naprawdę&nbsp;działają
                <svg 
            ...
            <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
              EasyLesson to tablica do korepetycji z wbudowanym AI, dostępem do wzorów matematycznych 
              i wszystkim, czego potrzebujesz do nauki online. Ucz i ucz się na inteligentnej tablicy.
            </p>
          ...
          <div className="relative z-10">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-blue-200 rounded-full blur-3xl opacity-50 animate-pulse" style={{ animationDelay: '1s' }} />
                ...
                <div className="relative aspect-video bg-gradient-to-br from-gray-100 to-gray-200">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center space-y-4">
                      ...
                      <div>
                        <p className="text-gray-700 font-semibold text-lg">Zobacz EasyLesson w akcji</p>
                  ...
                  >
                    {/* Tablica */}
                    <rect x="50" y="50" width="300" height="200" rx="10" fill="#4ade80" opacity="0.3" />
                    ...
                    <path d="M 200 180 Q 220 160 240 180" stroke="#166534" strokeWidth="3" fill="none" />
                  </svg>
                </div>
            ...
            <div className="absolute -top-12 right-12 animate-bounce" style={{ animationDuration: '3s' }}>
              <svg width="60" height="60" viewBox="0 0 60 60" fill="none">
                <path d="M30 5 L35 20 L50 20 L38 30 L43 45 L30 37 L17 45 L22 30 L10 20 L25 20 Z" 
                      fill="#fbbf24" 
                      stroke="#f59e0b" 
                      strokeWidth="2"
                />
