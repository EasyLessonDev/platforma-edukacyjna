    ...
    <section className="relative bg-gradient-to-br from-green-400 via-green-500 to-green-600 py-20 px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-10">
        <div className="relative max-w-screen-2xl mx-auto h-full">
          {/* Wzory po bokach */}
          <svg className="absolute left-[5%] top-[20%] rotate-12" width="100" height="60" viewBox="0 0 100 60">
            <text x="10" y="35" fill="white" fontSize="24" fontFamily="system-ui" fontWeight="600">
              √(x+y)
            </text>
          </svg>
          
          <svg className="absolute right-[8%] top-[25%] -rotate-12" width="120" height="70" viewBox="0 0 120 70">
            <text x="10" y="40" fill="white" fontSize="28" fontFamily="system-ui" fontWeight="600">
              ∫ f(x)dx
            </text>
          </svg>

          <svg className="absolute left-[10%] bottom-[25%] -rotate-6" width="90" height="60" viewBox="0 0 90 60">
            <text x="10" y="35" fill="white" fontSize="22" fontFamily="system-ui" fontWeight="600">
              a² + b²
            </text>
          </svg>

          <svg className="absolute right-[12%] bottom-[30%] rotate-8" width="110" height="65" viewBox="0 0 110 65">
      ...
      <div className="relative max-w-4xl mx-auto text-center z-10">
        ...
        <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto">
          Dołącz do <span className="font-bold text-white">1,200+ korepetytorów</span> którzy już uczą lepiej
        </p>
        ...
        <p className="text-white/80 text-sm md:text-base">
          ⚡ Założenie konta zajmuje 30 sekund
        </p>
