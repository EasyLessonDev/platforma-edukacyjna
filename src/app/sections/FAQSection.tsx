...
const faqs: FAQItem[] = [
  {
    ...
    answer: "Nie! EasyLesson jest prosty jak notes, ale potężny jak laboratorium. Jeśli potrafisz korzystać z Facebooka, poradzisz sobie z EasyLesson."
  },
  {
    question: "Czy uczeń musi mieć konto?",
    answer: "W planie Free - tak, uczeń musi się zarejestrować. W planie Pro - nie, może dołączyć przez link bez zakładania konta!"
  },
  {
    question: "Co jeśli skończą mi się wiadomości AI?",
    answer: "Możesz dokupić pakiet 100 wiadomości za €3. Lub przejść na plan Pro i mieć 500 wiadomości miesięcznie!"
  },
  {
    question: "Czy mogę anulować w każdej chwili?",
    answer: "Tak! Nie ma żadnych długoterminowych zobowiązań. Anulujesz subskrypcję kiedy chcesz, bez dodatkowych opłat."
  },
  {
    question: "Jakie przedmioty są wspierane?",
    answer: "Wszystkie! Ale najlepiej sprawdza się w matematyce, fizyce, chemii i innych przedmiotach ze wzorami. SmartSearch ma tysiące wzorów matematycznych i fizycznych."
  },
  {
    question: "Czy mogę używać EasyLesson na telefonie?",
    answer: "Tak! EasyLesson działa w przeglądarce, więc możesz korzystać z telefonu, tabletu lub komputera. Najlepsze doświadczenie jest na tablecie lub komputerze."
  },
  {
    question: "Czy dane są bezpieczne?",
    answer: "Absolutnie! Używamy szyfrowania SSL, a wszystkie dane są przechowywane bezpiecznie w chmurze. Nigdy nie udostępniamy Twoich danych osobowych."
  }
];
      ...
      <div className="relative max-w-4xl mx-auto z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 mt-6">
            Kliknij na pytanie żeby zobaczyć odpowiedź
          </p>
        </div>
